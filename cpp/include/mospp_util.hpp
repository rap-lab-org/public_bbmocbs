...
struct Label {
  Label() {};
  Label(long id0, long v0, basic::CostVector g0, basic::CostVector f0, long t0=0, long tb0=0) {
...
/**
 * @brief remove the first dimension.
 */
basic::CostVector vecProj(basic::CostVector v) ;
